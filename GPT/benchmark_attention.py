...
def estimate_kv_cache_size(config: GPTConfig, seq_len: int, batch_size: int, dtype_bytes: int = 4) -> float:
...
def print_summary(results: List[Dict]):
    ...
    # Header
    print(f"{'Config':<10} {'KV Heads':>10} {'Params':>12} {'KV Cache':>12} {'Memory':>12} {'Latency':>12} {'Tok/s':>10}")
...
def main():
    ...
    print(f"Config: d_model={args.d_model}, num_heads={args.num_heads}, num_layers={args.num_layers}")
    print(f"Generation: prompt_len={args.prompt_len}, gen_len={args.gen_len}, batch_size={args.batch_size}")
