import torch
import torchvision
from util import get_simclr_transform, SimCLRDataset
...
def main():
    ...
    train_loader = DataLoader(simclr_train, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, pin_memory=True, drop_last=True)
    ...
    for epoch in range(1, args.epochs+1):
        train_loss = train_one_epoch(model, train_loader, optimizer, args.temperature, device, epoch)
